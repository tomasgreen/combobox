...
(function() {
    ...
    this.stickyHeader = function(el, cls) {
        ...
        var i = parseInt(document.body.style.paddingTop, 10) || 0;
        window.addEventListener("optimizedScroll", function() {
            if (document.body.scrollTop > rect.top) {
                if (_hasClass(el, cls)) return;
                document.body.style.paddingTop = i + el.scrollHeight + 'px';
                _addClass(el, cls);
